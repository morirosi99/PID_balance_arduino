...
float PID, pwmBack, pwmFront, error, previous_error;
float pid_p=0;
float pid_i=0;
float pid_d=0;
/////////////////PID CONSTANTS/////////////////
...
/////////////////////////////I M U/////////////////////////////////////
   ...
   * begin functions we have to put this value.*/
    ...
    */
     ...
     *  will calculate the rooth square.*/
     /*---X---*/
     Acceleration_angle[0] = atan((Acc_rawY/16384.0)/sqrt(pow((Acc_rawX/16384.0),2) + pow((Acc_rawZ/16384.0),2)))*rad_to_deg; //  Pitch
     /*---Y---*/
     Acceleration_angle[1] = atan(-1*(Acc_rawX/16384.0)/sqrt(pow((Acc_rawY/16384.0),2) + pow((Acc_rawZ/16384.0),2)))*rad_to_deg; // Roll 
   ...
   *part that afects the angles and ofcourse multiply by 0.98 */
   ...
   //Total_angle_pt1[0] = Total_angle_pt1[0] * 0.0 + Total_angle[0] * 1;
